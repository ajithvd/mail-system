...
while(list($mid,$rid,$sid,$s,$m,$a,$d)=mysqli_fetch_array($dd))
{
	...
	echo "<td><a href='admin.php?coninb=$mid'>".$sid."</td>";
	echo "<td><a href='admin.php?coninb=$mid'>".$s."</a></td>";
	echo "<td><a href='admin.php?coninb=$mid'>".$d."</td>";
	echo "<td><a href='admin.php?coninb=$mid'>".$a."</td>"; 
	echo "</tr>";	
	}
	echo "</table>";
...
echo"<input type='submit' value='Delete' name='deletewq'/>";
 echo "</div>";
 echo "</form>";
?>
<script>
