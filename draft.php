...
while(list($draftId,$u_id,$sub,$file,$msg,$date)=mysqli_fetch_array($dd))
{
	...
	echo "<td><a href='HomePage.php?conq=$draftId'>".$sub."</td>";
	
	echo "<td><a href='HomePage.php?conq=$draftId'>".$file."</td>";
	echo "<td><a href='HomePage.php?conq=$draftId'>".$msg."</td>";
	echo "<td><a href='HomePage.php?conq=$draftId'>".$date."</td>";
	echo "</tr>";	
	}
	echo "</table>";
